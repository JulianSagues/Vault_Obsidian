...
![[Assets/U1_-_Sistemas_operativos 2.pdf|U1_-_Sistemas_operativos 2.pdf]]
...
1. DMA (acceso directo a memoria): pueden acceder cpu, memoria y ciertos dispositivos. Es un hardware y software——> se va a estudiar mejor en la UNIDAD de E/S. Con DMA se hace con solo una interrupcion.

1. Este ni idea preguntar…
