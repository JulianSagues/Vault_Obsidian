...
Una CPU **supraescalar** (o _superescalar_) es un diseño de arquitectura de procesador más avanzado que la canalización (_pipeline_), cuyo objetivo principal es **mejorar el rendimiento** utilizando múltiples unidades funcionales.
...
2. **Obtención y Búfer de Contención:** A la vez, se **obtienen y decodifican dos o más instrucciones**, las cuales se vacían en un **búfer de contención** (o _issue buffer_) hasta que se puedan ejecutar.
