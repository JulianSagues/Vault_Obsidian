...
- **Simula más memoria**: Junto con la RAM, el swap forma la llamada _memoria virtual_, dando la ilusión de que hay más memoria disponible de la que realmente existe.
