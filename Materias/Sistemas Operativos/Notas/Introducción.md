Sergio faccio: [sdfaccio@yahoo.com.ar](mailto:sdfaccio@yahoo.com.ar)

Leer capitulo de PROCESOS←——- De tanenbaum

**Leer las paginas de Org de computadoras un enfoque estructurado con los comentarios del profe**

Global: ultimos temas puede ser.Global: ultimos temas puede ser.

**Historia de los sistemas operativos ←—— Leer o ver video de youtube ←—— no lo toma**
## **Introducción**
...
- Ejecución de os mandatos de os usuarios/ interfaz de usuario </aside>
...
1. Sistemas Operativos Batch (Trabajo por Lotes)
...
1. Sistemas Operativos Multitarea – Monousuario
...
1. Sistemas Operativos Multitarea - Multiusuario
...
**Diagrama de proceso** LO TOMAAAAA EN FINALES (no va a ser necesario porque no vamos a ir a final)

**Se supone un cpu con un solo nucleo**. Los procesos nuevos van a una cola y el s.o lo admite, porque tiene recursos para admitirlo. Si no tiene los recursos no puede admitir al proceso.
...
**Compilación:** Tomo todo, lo paso por un proceso con un compilador, asignando posiciones de memoria para a,b,c. Todas son direcciones de memoria, Toma todas las instrucciones y la convierte a un nivel mas bajo. Por ejemplo de lvl 1 a lvl 2.

**Traducción:** toma una instrucción y hace todo el proceso anterior (compilación), solo para esa instrucción.
...
**Va a pedir presentar un tema, para compensar los días que no cursamos es ORAL**
...
_**Ejercicios de Gabinete ——→ verificar las respuestas en libro.**_

1. **Explicar el concepto de sistema operativo como una máquina extendida.**
...
3. Describa la información relevante del Kernel del sistema operativo, detallando su arquitectura, funciones principales, modos de operación, gestión de recursos y componentes internos.

RTA PROF: ——→ Completar con el libro

**Arquitectura de capas de un sistema operativo:**
